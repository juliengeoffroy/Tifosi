...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 24 mars 2025 à 18:44
...
-- Utilisateurs : `tifosi`
--
REVOKE ALL PRIVILEGES ON *.* FROM 'tifosi'@'localhost'; GRANT ALL PRIVILEGES ON *.* TO 'tifosi'@'localhost' REQUIRE NONE WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
...
CREATE TABLE IF NOT EXISTS `appartient` (
  ...
  KEY `appartient_ibfk_1` (`id_boisson`),
  KEY `appartient_ibfk_2` (`id_marque`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
